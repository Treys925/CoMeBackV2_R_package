...
#' Pearson Corrlation is used by default, appropriate for cell-type corrected methylation betas.
#'
...
#' @param Iarray which Illumina array platform, one of "450K" (default) or "EPIC".
...
#' @export cmr
cmr=function(Mdata,meds=NULL,Iarray=c("450K", "EPIC"),cormethod=c("pearson", "kendall", "spearman"), corlo=NULL,corhi=corlo,corlodst=400,corhidst=1, maxprbdst=2000, maxdlvl=Inf, verbose=TRUE){ #
  ...
  if (verbose) print("Getting CpG info, about to start estimation any day now.")
    ...
    else EPIC_Manifest=comeback:::init_data$EPIC_Manifest
